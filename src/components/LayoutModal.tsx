...
const LayoutModal: React.FC = () => {
    const { selectedItem, isLayoutModalOpen, closeLayoutModal, openDataVizModal } = useModalStore();

    if (!isLayoutModalOpen || !selectedItem || selectedItem.tab !== 'layouts') return null;
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg max-w-xl w-full p-6 relative">
                ...
                >
                    <span className="sr-only">Close Layout Modal</span>
                    <svg
                ...
                <div className="text-center">
                    <h3 className="text-2xl font-bold text-black mb-2">{selectedItem.title}</h3>
                ...
                <div className="mt-4 bg-gray-200 h-40 flex items-center justify-center">
                    <button onClick={handleViewDataViz} className="bg-blue-600 text-white px-4 py-2 rounded">
                        View Visualization
                    </button>
                </div>
                <div className="text-center">
