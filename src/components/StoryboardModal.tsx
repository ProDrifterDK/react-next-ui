...
const StoryboardModal: React.FC = () => {
    const { selectedItem, isStoryboardModalOpen, closeStoryboardModal } = useModalStore();

    if (!isStoryboardModalOpen || !selectedItem || selectedItem.tab !== 'storyboards') return null;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg max-w-xl w-full p-6 relative">
                <button
                    ...
                    aria-label="Close Storyboard Modal"
                >
                    <span className="sr-only">Close Storyboard Modal</span>
                    <svg
