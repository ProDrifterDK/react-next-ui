...
const KpiModal: React.FC = () => {
    const { selectedItem, isKpiModalOpen, closeKpiModal, openDataVizModal } = useModalStore();

    if (!isKpiModalOpen || !selectedItem || selectedItem.tab !== 'kpi') return null;
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg max-w-xl w-full p-6 relative">
                ...
                >
                    <span className="sr-only">Close KPI Modal</span>
                    <svg
